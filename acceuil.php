  ...
  <main>
    ...
    <section class="mission">
      <div class="container">
        ...
        <div class="mission__row">
          ...
          <div class="mission__art">
            <div class="chart-card">
              <canvas id="chart-perf" height="160"></canvas>
            </div>
            <div class="chart-row">
              <div class="chart-card small">
                <canvas id="chart-gauge" height="110"></canvas>
              </div>
              <div class="chart-card small">
        ...
        <!-- ligne carte verte + citation -->
        <div class="mission__row mission__row--alt">
          <div class="mission__art">
            <div class="chart-card soft">
              <canvas id="chart-green" height="130"></canvas>
            </div>
          </div>
    ...
    <section class="team" id="team">
      <div class="container">
        ...
        <div class="team__list">
          <span>Haitham</span><span>Ahmed</span><span>Noah</span><span>Arthur</span>
        </div>
      </div>
    </section>
  </main>
