...
CREATE TABLE `compte_utilisateur` (
  ...
  `mdp_hash` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `donnees_utilisateur`
--
...
CREATE TABLE `donnees_utilisateur` (
  ...
  `metabolisme_base` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `produits` (
  ...
  `energie_kcal` int(11) DEFAULT NULL,
...
CREATE TABLE `sports` (
  ...
  `kcal_h_60kg` int(11) DEFAULT NULL,
  `kcal_h_70kg` int(11) DEFAULT NULL,
  `kcal_h_80kg` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom`, `prenom`, `adresse`, `numero`, `mail`, `pswrd`, `date_creation`) VALUES
(1, 'Test', 'User', 'Montpellier', '0600000000', 'test@naha.fr', '$2y$10$BOwzA3PB.8iAdy1ltXQWoe1P06vvGxUIzRPF3CEy79V6O6Sv3pYlG', '2025-11-06 12:10:09'),
(2, 'artg', 'zrefcd', '927 ezhfzefd', '0293457238', 'arthur?neuille@gmail.com', '$2y$10$IFkjcsBNdBIPRdaXHhw9ceNcyDLzFqMi.W.QgjCg1I1WGMQ/SAmYG', '2025-11-12 16:49:42'),
(3, 'azaaz', 'aeaez', '7236 uaf', '9383467394', 'aerrhtu.fes@gelzvf.com', '$2y$10$KW3d.4pYn5Dm4KYODr0bwO6XLpsqteYJiqbQ/w4SfhL9C.8kAsFV.', '2025-11-12 16:50:36');
...
ALTER TABLE `activite`
  ADD PRIMARY KEY (`id_utilisateur`,`id_sport`,`date_sport`),
...
ALTER TABLE `consommation`
  ADD PRIMARY KEY (`id_utilisateur`,`id_produit`,`date_conso`),
  ADD KEY `id_produit` (`id_produit`);

--
-- Indexes for table `donnees_utilisateur`
--
ALTER TABLE `donnees_utilisateur`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `donnees_utilisateur`
--
ALTER TABLE `donnees_utilisateur`
...
ALTER TABLE `activite`
  ...
  ADD CONSTRAINT `fk_activite_user` FOREIGN KEY (`id_utilisateur`) REFERENCES `compte_utilisateur` (`id_utilisateur`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `consommation`
  ...
  ADD CONSTRAINT `fk_conso_user` FOREIGN KEY (`id_utilisateur`) REFERENCES `compte_utilisateur` (`id_utilisateur`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `donnees_utilisateur`
--
ALTER TABLE `donnees_utilisateur`
  ADD CONSTRAINT `fk_donnees_user` FOREIGN KEY (`id_utilisateur`) REFERENCES `compte_utilisateur` (`id_utilisateur`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
